...
class RequestApi(object):
    ...
    def gene_request(self, apiname, data, files=None, headers=None, flag=None):
    ...
    def get_result_request(self, taskid):
        return self.gene_request(api_get_result, data=self.gene_params(api_get_result, taskid=taskid), flag=1)
